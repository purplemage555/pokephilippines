const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PAWNIARD]	 = {{EVO_LEVEL, 26, SPECIES_BISHARP}},
    ...
    [SPECIES_DIGLETT]    = {{EVO_LEVEL, 24, SPECIES_DUGTRIO}},
    [SPECIES_MEOWTH]     = {{EVO_LEVEL, 28, SPECIES_PERSIAN}},
    [SPECIES_PSYDUCK]    = {{EVO_LEVEL, 33, SPECIES_GOLDUCK}},
    [SPECIES_SCRAGGY]	 = {{EVO_LEVEL, 26, SPECIES_SCRAFTY}},
    ...
    [SPECIES_GRIMER]     = {{EVO_LEVEL, 37, SPECIES_MUK}},
    ...
    [SPECIES_KOFFING]    = {{EVO_LEVEL, 37, SPECIES_WEEZING}},
    ...
    [SPECIES_SEADRA]     = {{EVO_TRADE_ITEM, ITEM_WATER_STONE, SPECIES_KINGDRA}},
    ...
    [SPECIES_DRATINI]    = {{EVO_LEVEL, 20, SPECIES_DRAGONAIR}},
    ...
    [SPECIES_JOLTIK]	 = {{EVO_LEVEL, 24, SPECIES_GALVANTULA}},
    ...
    [SPECIES_TYROGUE]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_HITMONCHAN},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_HITMONLEE},
    ...
    [SPECIES_LARVITAR]   = {{EVO_LEVEL, 20, SPECIES_PUPITAR}},
    ...
    [SPECIES_LOTAD]      = {{EVO_LEVEL, 15, SPECIES_LOMBRE}},
    ...
    [SPECIES_GOLETT]	 = {{EVO_LEVEL, 32, SPECIES_GOLURK}},
    ...
    [SPECIES_VIBRAVA]    = {{EVO_LEVEL, 50, SPECIES_FLYGON}},
    ...
    [SPECIES_YAMASK]	 = {{EVO_LEVEL, 31, SPECIES_COFAGRIGUS}},
    ...
    [SPECIES_DRIFLOON]	 = {{EVO_LEVEL, 31, SPECIES_DRIFBLIM}},
    ...
    [SPECIES_DEINO]	     = {{EVO_LEVEL, 20, SPECIES_ZWEILOUS}},
