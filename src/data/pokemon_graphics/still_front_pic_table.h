const struct CompressedSpriteSheet gMonStillFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(PAWNIARD,     gMonStillFrontPic_Pawniard),
...
// Gen III
    ...
    SPECIES_SPRITE(LUNALA,      gMonStillFrontPic_Lunala),
    ...
    SPECIES_SPRITE(YAMASK,       gMonStillFrontPic_Yamask),
    ...
    SPECIES_SPRITE(DEINO,         gMonStillFrontPic_Deino),
    SPECIES_SPRITE(ZWEILOUS,       gMonStillFrontPic_Zweilous),
    SPECIES_SPRITE(HYDREIGON,     gMonStillFrontPic_Hydreigon),
